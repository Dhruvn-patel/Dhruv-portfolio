...
export const metadata: Metadata = {
  title: "Dhruv Patel",
  description:
    "Dhruv Patel is a proficient Software Engineer and Full Stack Developer from India, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  keywords: [
    ...
    "dhruv1669",
    "dhruvn-patel",
    "freelancer dhruvpatel",
    "frontend developer",
    "full stack developer",
    "indian developer",
    "dhruvnpatel github",
    "dhruvnpatel linkedin",
